...
<body>
   ...
   <section class="edit-product-form" id="editForm">
    ...
    <script>
        ...
        document.getElementById('close-update')?.addEventListener('click', function (e) {
            e.preventDefault(); // Prevent form reset behavior
            document.getElementById('editForm').style.display = 'none';
            window.history.pushState({}, document.title, window.location.pathname); // Remove ?update=X from URL
        });
    </script>
